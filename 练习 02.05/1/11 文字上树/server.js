...
var user = [
    {username: 'zhangsan', pwd: '123', hobby: {a: '读书', b: '听音乐'}},
    {username: 'lisi', pwd: '123', hobby: {a: '写字', b: '跑步'}},
    {username: 'wangwu', pwd: '123456', hobby: {a: '钓鱼', b: '看钓鱼视频'}},
];
...
http.createServer(function (req, res) {
    ...
    // get ajax加载数据
    if (pathname == '/get_msg' && method == 'get') {
        res.setHeader('content-type', 'text/html;charset=utf-8');
